...
public class testXml {
	public static void main(String[] args) throws JAXBException {
		...
		for (Pays pays : listPays) {
			...
			System.out.println("population : "+pays.getDonneeDemographique().getPopulation().getInfo());
			System.out.println("taux de fecondité : "+pays.getDonneeDemographique().getFecondite().getInfo());
			System.out.println("pib : "+pays.getDonneeEconomique().getPib().getInfo());
